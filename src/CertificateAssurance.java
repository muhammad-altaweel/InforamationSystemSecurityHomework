...
public class CertificateAssurance {
        ...
        try (ServerSocket listener = new ServerSocket(22222)) {
            ...
            while (true) {
                try (Socket socket = listener.accept()) {
                    ...
                    if (signedSecretMessage.verify(csrRequest.getPublicKey(), sig) && secretMessage.equals(RecievedSecretMessage)) {   //The CSR was verified succefully
